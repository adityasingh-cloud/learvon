        ...
        html: `
          <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; background: #0A1628; color: #C8D8E8; padding: 32px; border-radius: 12px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px; width: 40%;">Full Name</td>
                <td style="padding: 10px 0; color: #FFFFFF; font-weight: 600;">${data.full_name}</td>
              </tr>
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px;">Email</td>
                <td style="padding: 10px 0;"><a href="mailto:${data.email}" style="color: #00C9A7;">${data.email}</a></td>
              </tr>
              ${data.phone ? `
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px;">Phone</td>
                <td style="padding: 10px 0;"><a href="tel:${data.phone}" style="color: #00C9A7;">${data.phone}</a></td>
              </tr>` : ""}
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px;">Business</td>
                <td style="padding: 10px 0; color: #FFFFFF; font-weight: 600;">${data.business_name}</td>
              </tr>
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px;">Business Type</td>
                <td style="padding: 10px 0; color: #FFFFFF;">${data.business_type.replace(/_/g, " ")}</td>
              </tr>
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px;">Services Needed</td>
                <td style="padding: 10px 0; color: #FFD93D; font-weight: 600;">${formatServices(data.services_needed)}</td>
              </tr>
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px;">Monthly Budget</td>
                <td style="padding: 10px 0; color: #00C9A7; font-weight: 700; font-size: 18px;">${formatBudget(data.monthly_budget)}/month</td>
              </tr>
              <tr style="border-top: 1px solid #1E3A5F;">
                <td style="padding: 10px 0; color: #7A8EA0; font-size: 13px; vertical-align: top;">Message</td>
                <td style="padding: 10px 0; color: #C8D8E8; line-height: 1.6;">${data.message}</td>
              </tr>
            </table>
            ...
            <div style="margin-top: 16px; text-align: center;">
              <a href="mailto:${data.email}?subject=Re: Your Leavron inquiry — Let's talk!" 
                 style="display: inline-block; background: #00C9A7; color: #0A1628; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 14px;">
      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; background: #0A1628; color: #C8D8E8; padding: 32px; border-radius: 12px;">
            ...
            <p style="color: #00C9A7; font-size: 16px; margin: 0 0 24px;">
              Your message reached me. I'll be in touch within 2 hours.
            </p>
            ...
            <p style="line-height: 1.7; color: #C8D8E8;">
              I personally review every single inquiry. Before our call, I'll research 
              <strong style="color: #FFFFFF;">${data.business_name}</strong> so I already have 
              ideas ready for you — no generic advice, only what fits your business.
            </p>

            <p style="line-height: 1.7; color: #C8D8E8; margin-top: 16px;">
              While you wait, feel free to check out our work at 
              <a href="${process.env.NEXT_PUBLIC_SITE_URL}" style="color: #00C9A7;">leavron.in</a>
              or connect with me on 
              <a href="https://instagram.com/leavron" style="color: #00C9A7;">Instagram</a>.
            </p>
...
export async function GET() {
  return NextResponse.json({
    success: true,
    message: "Leavron Contact API is running ✅",
  });
}
